...
class RackioObserverLSTMCell(tf.keras.layers.Layer):
    r"""
    Documentation here
    """
    def __init__(self, units, activation='tanh', return_sequences=False, **kwargs):
        ...
        Documentation here
        """
        super(RackioObserverLSTMCell, self).__init__(**kwargs)
        self.units = units
...
class RackioObserver(tf.keras.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # INITIALIZATION
        self.scaler = ObserverScaler(scaler)
    ...
    def predict(
        ...
        **kwargs
        ...
        y = super(RackioObserver, self).predict(x, **kwargs)
    ...
    def evaluate(
        ...
        **kwargs
        ...
        if plot_prediction:
            ...
            y_predict = super(RackioObserver, self).predict(x, **kwargs)
