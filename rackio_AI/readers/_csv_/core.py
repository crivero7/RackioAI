...
class CSV:
    ...
    def read(self, csv_files, _format=None, **csv_options):
        ...
        * **:param sep:** * **(str, default ‘,’)** *
        ...
        '\s+' will be interpreted as regular expressions and will also force the use of the Python parsing 
        engine. Note that regex delimiters are prone to ignoring quoted data. Regex example: '\r\t'.
        ...
        * **:param delim_whitespace:** * **(bool, default False)** *
        ...
        Specifies whether or not whitespace (e.g. ' ' or '    ') will be used as the sep. Equivalent to 
